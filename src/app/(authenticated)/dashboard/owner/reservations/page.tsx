    ...
    <ProtectedRoute>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Filtra por estado o cancha y confirma o cancela reservas
            </p>
          </div>
          <Button
        ...
        <ManualReservationModal
          ...
          fields={ownerFields}
          onSuccess={() => utils.reservation.listForOwner.invalidate()}
        />
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <Link href="/dashboard/owner/fields">
                  <Button variant="outline">Ver mis canchas</Button>
                </Link>
              </div>
            ) : (
              <>
                              ...
                              <DropdownMenu>
                                ...
                                >
                                  ...
                                  <DropdownMenuItem asChild>
                                    <Link
                                      href={`/dashboard/owner/fields/${r.field.id}`}
                                      className="cursor-pointer text-foreground"
                                    >
                                      Ver cancha
                                    </Link>
