...
export const LocaleFindFirstOrThrowSelectSchema: z.ZodType<Prisma.LocaleSelect> =
  z
    .object({
...
export const LocaleFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    languageCode: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const LocaleFindFirstOrThrowSchema: z.ZodType<Prisma.LocaleFindFirstOrThrowArgs> =
  z
    .object({
      select: LocaleFindFirstOrThrowSelectSchema.optional(),
      ...
      distinct: z
        .union([
          LocaleScalarFieldEnumSchema,
          LocaleScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.LocaleFindFirstOrThrowArgs>;

export const LocaleFindFirstOrThrowZodSchema = z
  .object({
    select: LocaleFindFirstOrThrowSelectSchema.optional(),
    include: LocaleIncludeObjectSchema.optional(),
    orderBy: z
