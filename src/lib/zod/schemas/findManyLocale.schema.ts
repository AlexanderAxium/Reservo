...
export const LocaleFindManySelectSchema: z.ZodType<Prisma.LocaleSelect> = z
  .object({
...
export const LocaleFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    languageCode: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const LocaleFindManySchema: z.ZodType<Prisma.LocaleFindManyArgs> = z
  .object({
    select: LocaleFindManySelectSchema.optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.LocaleFindManyArgs>;

export const LocaleFindManyZodSchema = z
  .object({
    select: LocaleFindManySelectSchema.optional(),
    include: LocaleIncludeObjectSchema.optional(),
    orderBy: z
