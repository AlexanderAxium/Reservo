...
export const SessionFindManySelectSchema: z.ZodType<Prisma.SessionSelect> = z
  .object({
...
export const SessionFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    token: z.boolean().optional(),
...
export const SessionFindManySchema: z.ZodType<Prisma.SessionFindManyArgs> = z
  .object({
    select: SessionFindManySelectSchema.optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.SessionFindManyArgs>;

export const SessionFindManyZodSchema = z
  .object({
    select: SessionFindManySelectSchema.optional(),
    include: SessionIncludeObjectSchema.optional(),
    orderBy: z
