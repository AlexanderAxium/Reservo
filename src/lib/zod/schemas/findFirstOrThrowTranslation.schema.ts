...
export const TranslationFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TranslationSelect> =
  z
    .object({
...
export const TranslationFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    translatableType: z.boolean().optional(),
    translatableId: z.boolean().optional(),
...
export const TranslationFindFirstOrThrowSchema: z.ZodType<Prisma.TranslationFindFirstOrThrowArgs> =
  z
    .object({
      select: TranslationFindFirstOrThrowSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.TranslationFindFirstOrThrowArgs>;

export const TranslationFindFirstOrThrowZodSchema = z
  .object({
    select: TranslationFindFirstOrThrowSelectSchema.optional(),
    include: TranslationIncludeObjectSchema.optional(),
    orderBy: z
