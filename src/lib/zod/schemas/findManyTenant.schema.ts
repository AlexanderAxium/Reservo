...
export const TenantFindManySelectSchema: z.ZodType<Prisma.TenantSelect> = z
  .object({
...
export const TenantFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    displayName: z.boolean().optional(),
...
export const TenantFindManySchema: z.ZodType<Prisma.TenantFindManyArgs> = z
  .object({
    select: TenantFindManySelectSchema.optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.TenantFindManyArgs>;

export const TenantFindManyZodSchema = z
  .object({
    select: TenantFindManySelectSchema.optional(),
    include: TenantIncludeObjectSchema.optional(),
    orderBy: z
