...
export const RolePermissionFindManySelectSchema: z.ZodType<Prisma.RolePermissionSelect> =
  z
    .object({
...
export const RolePermissionFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    roleId: z.boolean().optional(),
    permissionId: z.boolean().optional(),
...
export const RolePermissionFindManySchema: z.ZodType<Prisma.RolePermissionFindManyArgs> =
  z
    .object({
      select: RolePermissionFindManySelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.RolePermissionFindManyArgs>;

export const RolePermissionFindManyZodSchema = z
  .object({
    select: RolePermissionFindManySelectSchema.optional(),
    include: RolePermissionIncludeObjectSchema.optional(),
    orderBy: z
