...
export const TenantFindFirstSelectSchema: z.ZodType<Prisma.TenantSelect> = z
  .object({
...
export const TenantFindFirstSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    displayName: z.boolean().optional(),
...
export const TenantFindFirstSchema: z.ZodType<Prisma.TenantFindFirstArgs> = z
  .object({
    select: TenantFindFirstSelectSchema.optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.TenantFindFirstArgs>;

export const TenantFindFirstZodSchema = z
  .object({
    select: TenantFindFirstSelectSchema.optional(),
    include: TenantIncludeObjectSchema.optional(),
    orderBy: z
