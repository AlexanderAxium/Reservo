...
export const RoleFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RoleSelect> = z
  .object({
...
export const RoleFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    displayName: z.boolean().optional(),
...
export const RoleFindFirstOrThrowSchema: z.ZodType<Prisma.RoleFindFirstOrThrowArgs> =
  z
    .object({
      select: RoleFindFirstOrThrowSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.RoleFindFirstOrThrowArgs>;

export const RoleFindFirstOrThrowZodSchema = z
  .object({
    select: RoleFindFirstOrThrowSelectSchema.optional(),
    include: RoleIncludeObjectSchema.optional(),
    orderBy: z
