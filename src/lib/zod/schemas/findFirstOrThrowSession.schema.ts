...
export const SessionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SessionSelect> =
  z
    .object({
...
export const SessionFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    token: z.boolean().optional(),
...
export const SessionFindFirstOrThrowSchema: z.ZodType<Prisma.SessionFindFirstOrThrowArgs> =
  z
    .object({
      select: SessionFindFirstOrThrowSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.SessionFindFirstOrThrowArgs>;

export const SessionFindFirstOrThrowZodSchema = z
  .object({
    select: SessionFindFirstOrThrowSelectSchema.optional(),
    include: SessionIncludeObjectSchema.optional(),
    orderBy: z
