...
const makeSchema = () =>
  z
    .object({
      ...
      users: z.lazy(
        () => UserUncheckedCreateNestedManyWithoutTenantInputObjectSchema
      ),
      permissions: z.lazy(
        () => PermissionUncheckedCreateNestedManyWithoutTenantInputObjectSchema
      ),
      roles: z.lazy(
        () => RoleUncheckedCreateNestedManyWithoutTenantInputObjectSchema
      ),
      translations: z.lazy(
    ...
    .strict();
export const TenantUncheckedCreateInputObjectSchema: z.ZodType<Prisma.TenantUncheckedCreateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.TenantUncheckedCreateInput>;
