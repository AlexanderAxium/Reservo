...
const makeSchema = () =>
  z
    ...
    .strict();
export const TranslationMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.TranslationMaxOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.TranslationMaxOrderByAggregateInput>;
