...
const makeSchema = () =>
  z
    ...
    .strict();
export const LocaleMinOrderByAggregateInputObjectSchema: z.ZodType<Prisma.LocaleMinOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.LocaleMinOrderByAggregateInput>;
export const LocaleMinOrderByAggregateInputObjectZodSchema = makeSchema();
