...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserRoleCreateOrConnectWithoutUserInputObjectSchema: z.ZodType<Prisma.UserRoleCreateOrConnectWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserRoleCreateOrConnectWithoutUserInput>;
export const UserRoleCreateOrConnectWithoutUserInputObjectZodSchema =
  makeSchema();
