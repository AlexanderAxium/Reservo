...
const makeSchema = () =>
  z
    ...
    .strict();
export const LocaleMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.LocaleMaxOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.LocaleMaxOrderByAggregateInput>;
export const LocaleMaxOrderByAggregateInputObjectZodSchema = makeSchema();
