...
const makeSchema = () =>
  z
    ...
    .strict();
export const RoleCreateNestedManyWithoutTenantInputObjectSchema: z.ZodType<Prisma.RoleCreateNestedManyWithoutTenantInput> =
  makeSchema() as unknown as z.ZodType<Prisma.RoleCreateNestedManyWithoutTenantInput>;
export const RoleCreateNestedManyWithoutTenantInputObjectZodSchema =
  makeSchema();
