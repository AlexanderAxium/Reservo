...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserRoleCreateNestedManyWithoutRoleInputObjectSchema: z.ZodType<Prisma.UserRoleCreateNestedManyWithoutRoleInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserRoleCreateNestedManyWithoutRoleInput>;
export const UserRoleCreateNestedManyWithoutRoleInputObjectZodSchema =
  makeSchema();
