...
const makeSchema = () =>
  z
    ...
    .strict();
export const SessionCreateManyUserInputEnvelopeObjectSchema: z.ZodType<Prisma.SessionCreateManyUserInputEnvelope> =
  makeSchema() as unknown as z.ZodType<Prisma.SessionCreateManyUserInputEnvelope>;
