...
import { TenantUpdateOneWithoutUsersNestedInputObjectSchema } from "./TenantUpdateOneWithoutUsersNestedInput.schema";
  ...
  z
    .object({
      ...
      sessions: z
        ...
        .optional(),
      tenant: z
        .lazy(() => TenantUpdateOneWithoutUsersNestedInputObjectSchema)
        .optional(),
    })
    .strict();
export const UserUpdateWithoutUserRolesInputObjectSchema: z.ZodType<Prisma.UserUpdateWithoutUserRolesInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpdateWithoutUserRolesInput>;
export const UserUpdateWithoutUserRolesInputObjectZodSchema = makeSchema();
