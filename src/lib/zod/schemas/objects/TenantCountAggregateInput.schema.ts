...
const makeSchema = () =>
  z
    ...
    .strict();
export const TenantCountAggregateInputObjectSchema: z.ZodType<Prisma.TenantCountAggregateInputType> =
  makeSchema() as unknown as z.ZodType<Prisma.TenantCountAggregateInputType>;
