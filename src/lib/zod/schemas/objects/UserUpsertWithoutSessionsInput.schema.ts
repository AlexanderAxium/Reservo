...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserUpsertWithoutSessionsInputObjectSchema: z.ZodType<Prisma.UserUpsertWithoutSessionsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUpsertWithoutSessionsInput>;
