...
const makeSchema = () =>
  z
    ...
    .strict();
export const RolePermissionUpdateInputObjectSchema: z.ZodType<Prisma.RolePermissionUpdateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.RolePermissionUpdateInput>;
export const RolePermissionUpdateInputObjectZodSchema = makeSchema();
