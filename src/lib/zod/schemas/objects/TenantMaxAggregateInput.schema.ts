...
const makeSchema = () =>
  z
    ...
    .strict();
export const TenantMaxAggregateInputObjectSchema: z.ZodType<Prisma.TenantMaxAggregateInputType> =
  makeSchema() as unknown as z.ZodType<Prisma.TenantMaxAggregateInputType>;
