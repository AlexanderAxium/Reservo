...
const makeSchema = () =>
  z
    ...
    .strict();
export const TenantMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.TenantMaxOrderByAggregateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.TenantMaxOrderByAggregateInput>;
