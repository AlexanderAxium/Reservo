...
import { TenantUpdateOneRequiredWithoutPermissionsNestedInputObjectSchema } from "./TenantUpdateOneRequiredWithoutPermissionsNestedInput.schema";
...
const makeSchema = () =>
  z
    .object({
      ...
      tenant: z
        .lazy(
          () => TenantUpdateOneRequiredWithoutPermissionsNestedInputObjectSchema
        )
        .optional(),
    })
    .strict();
export const PermissionUpdateWithoutRolePermissionsInputObjectSchema: z.ZodType<Prisma.PermissionUpdateWithoutRolePermissionsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.PermissionUpdateWithoutRolePermissionsInput>;
export const PermissionUpdateWithoutRolePermissionsInputObjectZodSchema =
  makeSchema();
