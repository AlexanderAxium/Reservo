...
const makeSchema = () =>
  z
    ...
    .strict();
export const LocaleCountAggregateInputObjectSchema: z.ZodType<Prisma.LocaleCountAggregateInputType> =
  makeSchema() as unknown as z.ZodType<Prisma.LocaleCountAggregateInputType>;
export const LocaleCountAggregateInputObjectZodSchema = makeSchema();
