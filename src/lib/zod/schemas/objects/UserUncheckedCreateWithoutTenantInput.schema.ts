...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserUncheckedCreateWithoutTenantInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutTenantInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserUncheckedCreateWithoutTenantInput>;
export const UserUncheckedCreateWithoutTenantInputObjectZodSchema =
  makeSchema();
