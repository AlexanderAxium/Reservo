...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserRoleCreateNestedManyWithoutUserInputObjectSchema: z.ZodType<Prisma.UserRoleCreateNestedManyWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserRoleCreateNestedManyWithoutUserInput>;
export const UserRoleCreateNestedManyWithoutUserInputObjectZodSchema =
  makeSchema();
